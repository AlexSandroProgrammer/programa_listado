...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-03-2018 a las 13:40:21
...
(1, 1, 1, 1, 'CONTROL DE LA PRODUCCION 	FORMATO DE FICHAS TECNICAS DE LOS CULTIVOS', '04 FOr FTC 01 fich tec cult.xls', 'Formato', 'FOr-FTC-04-01/11-13', 1, '2013-02-01', 1),
...
INSERT INTO `procedimiento` (`Id_Procedimiento`, `Nombre_Procedimiento`) VALUES
(1, 'PLANEACION Y CONTROL DE LA PRODUCCION'),
(2, 'CONTROL DE INVENTARIOS'),
(3, 'PLANEACION OPERATIVA'),
(4, 'PRESTACION Y CONTROL DEL SERVICIO'),
(13, 'PLANEACION ADMINISTRATIVA Y OPERATIVA '),
(14, 'PROGRAMACION Y CONTROL DE TURNOS'),
(15, 'MUESTREO Y VALIDACION'),
(16, 'LIMPIEZA Y DESINFECCION'),
(17, 'MANTENIMIENTO'),
(18, 'ELABORACIÃ“N DE NOMINA'),
(19, 'GESTIÃ“N FINANCIERA Y CONTABLE'),
(20, 'AUDITORIAS INTERNAS'),
(21, 'MERCADEO Y VENTAS'),
(22, 'SELECCIÃ“N, DESARROLLO Y EVALUACIÃ“N DE DESEMPEÃ‘O DE PERSONAL '),
(23, 'CONTROL Y REGISTROS DE DOCUMENTOS '),
(24, 'ACCIONES PREVENTIVAS Y CORRECTIVAS'),
(25, 'CONTROL DEL PRODUCTO O SERVICIO NO CONFORME'),
(26, 'INTRUCTIVO DE NOMBRES DE ARCHIVOS'),
(27, 'FORMATO DE INFORME SEMANAL DE ACTIVIDADES '),
(28, 'FORMATO ASISTENCIA DE VISITAS AL CENTRO'),
(29, 'FORMATO DE TURNOS DE APOYO FIN DE SEMANA '),
(30, 'FORMATO DE PERMISOS SENA EMPRESA DOMINGO '),
(31, 'FORMATO DE REPORTE NOVEDADES DE NOMINA '),
(32, 'FORMATO DE REGISTRO Y VERIFICACIÃ“N DE DOCUMENTOS EN EL LISTADO MAESTRO'),
(33, 'FORMATO LISTADO DE INGRESO AL CENTRO FIN DE SEMANA '),
(34, 'MEMORANDO TURNOS '),
(35, ' MEMORANDO SENA EMPRESA '),
(36, 'PLANEACION Y CONTROL DE CALIDAD');
...
--
ALTER TABLE `procedimiento`
  MODIFY `Id_Procedimiento` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT de la tabla `proceso`
--
ALTER TABLE `proceso`
  MODIFY `Id_Proceso` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
