...
<div class="row">
<div class="col-md-12">
	<h3 class="help-block text-center">Areas</h3>
	<hr>
</div>
...
<div class="row">
	...
	<div class="col-md-3"><br><input type="button" id="btnregistrar_argumento" onclick="enviar()" class="btn btn-danger form-control" value="Registrar Area">
<input type="button" id="btnactualizar_argumento" onclick="actualizar()" class="btn btn-danger form-control" value="Actualizar  Area">
	</div>
</div>
