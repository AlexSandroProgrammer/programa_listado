...
include '../conexion.php';
	...
	<title>LISTADO MAESTRO RESPONSABLE</title>
...
<div class="row">
<div class="col-md-12">
	<h3 class="help-block text-center">RESPONSABLE</h3>
	<hr>
</div>
...
<div class="row">
	...
	<div class="col-md-3"><br><input type="button" id="btnregistrar_argumento" onclick="enviar()" class="btn btn-danger form-control" value="Registrar Responsable">
<input type="button" id="btnactualizar_argumento" onclick="actualizar()" class="btn btn-danger form-control" value="Actualizar  Responsable">
	</div>
</div>
...
function valiadar_argumento() {
  ...
  if(argumento==null  || argumento.length==0 || /[\\^"'<>;ç`,_ª%&¿°¨Ç¡º#~¬€$.*+?=!:|\\/\[\]{}]/.test(argumento)){
