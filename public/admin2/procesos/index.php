...
include '../conexion.php';
	...
	<title>LISTADO MAESTRO PROCESOS</title>
...
<div class="row">
<div class="col-md-12">
	<h3 class="help-block text-center">PROCESOS</h3>
	<hr>
</div>
...
<div class="row">
	...
	<div class="col-md-3"><br><input type="button" id="btnregistrar_argumento" onclick="enviar()" class="btn btn-danger form-control" value="Registrar Proceso">
<input type="button" id="btnactualizar_argumento" onclick="actualizar()" class="btn btn-danger form-control" value="Actualizar  Proceso">
	</div>
</div>
