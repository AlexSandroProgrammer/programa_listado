...
<body>
    <header class="p-4">
        ...
        <div class="row justify-content-end px-3">
            ...
            <a href="../user/index.php" class="text-center text-light  btn btn-success">
                Regresar
            </a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="../../../admin/documentos/documentos/<?php echo $document['Nombre_Documento_Magnetico'] ?>" class="icon icon-download btn form-control">
                                        </a></td>
                                    ...
                                    <td><?php echo $document['Nombre_Documento_Magnetico'] ?> <a href="../../../admin/documentos/documentos/<?php echo $document['Nombre_Documento_Magnetico'] ?>"><?php echo $document['Nombre_Documento_Magnetico'] ?></a>
                                    </td>
