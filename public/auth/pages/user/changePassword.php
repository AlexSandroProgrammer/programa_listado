        ...
        <div class="contenedor-texto">
            <div class="contenedor-form">
                <div class="container-center">
                    ...
                    <div class="mt-5">
                        <h1 class="titulo_login">Verificacion de Usuario </h1>
                        <p class="descripcion">Por favor ingrese su nombre de usuario registrado en el sistema para
                            habilitar el cambio de su cuenta.</p>
