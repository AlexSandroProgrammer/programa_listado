...
?>
    ...
    <head>
        ...
        <title>Error Inicio de sesion || CompromisoSE</title>
                ...
                <div class="contenedor-form">
                    ...
                    ==========================================-->
                        <form action="../../controller/AuthController.php" autocomplete="off" method="POST" id="formLogin" class="formulario active">
                            ...
                            <input type="text" placeholder="Ingresa tu nombre de usuario" class="input-text" name="username" required autocomplete="off">
