...
$sentencia = $connection->query("SELECT ventas.total,ventas.fecha, ventas.id,ventas.fecha_fin,user.name,motorcycles.placa,services.service,GROUP_CONCAT(services.code_service, '..',services.service, '..' SEPARATOR '__') AS services FROM ventas INNER JOIN servicios_vendidos ON servicios_vendidos.id_venta = ventas.id INNER JOIN services ON services.id_services = servicios_vendidos.id INNER JOIN user ON user.document=ventas.document INNER JOIN motorcycles ON  motorcycles.placa=ventas.placa GROUP BY ventas.id ORDER BY ventas.id;");
...
<body>
    <div class="wrapper">
        ...
        <div class="xp-breadcrumbbar text-center">
            <h2 class="page-title"><span>LISTADO DE VENTAS</span></h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php foreach (explode("__", $venta->servicios) as $documentosConcatenados) {
                                                    $servicio = explode("..", $documentosConcatenados)
                                                ?>
                                                    <tr>
