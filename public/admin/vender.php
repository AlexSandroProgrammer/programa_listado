	...
	<div>
		...
		<div class="container-fluid">
			<div class="col-xs-12">
				...
				<form action="terminarVenta.php" method="POST" name="MM_forms">
					<br>
					<label>Vendedor:</label>
					<select name="document" required  id="" class='form-control'>
					...
					<select name="placa" required id="" class='form-control'>
