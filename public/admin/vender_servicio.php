...
?>
<?php
if (!isset($_SESSION["carritoServicio"])) $_SESSION["carritoServicio"] = [];
$granTotal = 0;
?>
	...
	<div>
		...
		<div class="container-fluid">
			...
			<div class="content" id="content3">
				<form method="post" name="formServices" action="agregar_ser.php">
				...
				<table class="table table-bordered">
					...
					<tbody>
						<?php foreach ($_SESSION["carritoServicio"] as $indice => $servicio) {
						...
						?>
							<tr>
								...
								<td><a class="btn btn-danger" href="<?php echo "borrarServicio.php?indice=" . $indice ?>" Style='color:white;'>Eliminar<i class="fa fa-trash"></i></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
			...
			<form action="./terminarVentaServicio.php" method="POST" name="cartForm">
				<br>
				...
				<div class=" mb-4">
					...
					<a href="./cancelarVentaServicio.php" class="btn btn-danger">Cancelar venta</a>
				</div>
