                        ...
                        ?>
                            <tr>
                                <td>
                                    ...
                                    <a class=" btn btn-secondary mt-2" onclick="openPops('<?php echo $document['nombre_directorio_proceso'] ?>/<?php echo $document['nombre_directorio_procedimiento'] ?>/<?php echo $document['nombre_documento_magnetico'] ?>')"><i class="fa fa-eye"></i>
                                    </a>
                                    <form method="GET" action="archivar-documento.php">
                                        <input type="hidden" name="id_archive_document" value="<?= $document['id_documento'] ?>">
                                        <button class="btn btn-warning mt-2" onclick="return confirm('desea enviar a cuarentena el formato seleccionado');" type="submit"> <i class="fa fa-archive"></i></button>
                                    </form>
