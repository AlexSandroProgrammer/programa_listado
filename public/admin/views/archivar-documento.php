...
?>
    ...
    <div class="container-fluid p-3 bg-light-subtle">
        <div class="col-xs-12 bg-light-subtle border p-4">
            ...
            <form action="../controllers/DocumentoController.php" method="POST" enctype="multipart/form-data" autocomplete="off" name="formArchiveDocument">
                <div class="row">
                    <div class="col-12 p-2" hidden>
                        <input type="text" hidden required class="form-control" id="id_document" value="<?php echo $document['id_documento'] ?> " name="idDocument">
                    </div>
                    <div class="col-12 p-2" hidden>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="hidden" required class="btn btn-info" value="formArchiveDocument" name="MM_archiveDocument">
