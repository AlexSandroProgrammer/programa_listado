...
?>
    ...
    <div class="container-fluid p-3 bg-light-subtle">
        <div class="col-xs-12 bg-light-subtle border p-4">
            ...
            <form action="../controllers/DocumentoController.php" method="POST" enctype="multipart/form-data" autocomplete="off" name="formUpdateDocument">
                <div class="row">
                    <div class="col-md-6 p-2">
                        <span class="help-block">Nombre del Documento</span>
                        <input type="text" autofocus required class="form-control" id="nombre_documento" value="<?php echo $document['nombre_documento'] ?> " name="nombreDocumento">
                    </div>
                    <div class="col-md-6 p-2">
                    ...
                    <div class="col-md-6 p-2" id="detalle_procedimiento" style="display: none;">
                        ...
                        <input type="text" required class="form-control" id="nombre_procedimiento" value="<?php echo $document['id_proceso'] ?> " name="idProceso" readonly>
                    </div>
                    ...
                    <div class="col-md-6 p-2">
                        ...
                        <select class="form-control" required id="Id_tipo_doc" value="<?php echo $document['tipo_documento'] ?> " name="tipoDocumento">
                    ...
                    <div class="mt-4">
                        ...
                        <input type="hidden" required class="btn btn-info" value="formUpdateDocument" name="MM_updateDocument">
